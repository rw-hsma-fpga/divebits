...
DiveBits is a framework of IP components and Xilinx tool flow extensions that enable easy generation of multiple bitstream copies with individual constant data (\textit{diversified} bitstreams).
...
\begin{itemize}
	\item Call \esrtype{DB\_DEMO} in the Tcl console to list all the required commands again.
...
\newpage
\section{List of data-receiving DiveBits components}
\label{sec:dbcomps}
